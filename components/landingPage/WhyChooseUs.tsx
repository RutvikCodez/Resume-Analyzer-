      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-24 space-y-5'>
          ...
          <p className='text-lg text-white/65 max-w-2xl mx-auto'>
            A real-world AI interview platform built to simulate modern hiring
            pipelines used by top tech companies.
          </p>
        </div>
          ...
          {featuresGridData.map((feature, i) => (
            <div
              ...
              <div
                className='
                  absolute inset-0
                  bg-linearx-to-br from-purple-600/15 via-purple-600/5 to-transparent
